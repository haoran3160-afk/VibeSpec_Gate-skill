...
VibeSec Gate Lite should add a focused login-security review lane for vibe-coded products.
...
The implementation should remain narrow, evidence-driven, and safe-by-default. It should improve launch-blocking judgment without turning VibeSec Gate Lite into a live offensive scanner.
